...
public enum ErrorCode implements ErrorConst {
	...
	REQ_PARA_HEADER_ERROR(REQ_PARA_HEADER_ERROR_CODE,"HEADER参数缺失"),
	REQ_PARA_EMPTY_ERROR(REQ_PARA_EMPTY_ERROR_CODE,"请求参数为空"),
	REQ_PARA_INVALID_ERROR(REQ_PARA_INVALID_ERROR_CODE,"请求参数为失效参数"),
