...
@EnableConfigurationProperties(MongOptionProperties.class)
@ConditionalOnMissingBean(type = "org.springframework.data.mongodb.MongoDbFactory")
public class MongoClinetConfig {
    @Bean
    public MongoClientOptions mongoClientOptions(MongOptionProperties mongoOptionProperties) {
