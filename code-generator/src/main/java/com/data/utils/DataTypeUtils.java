...
public class DataTypeUtils {
	...
	public static Map<String, Class> javaTypeClassMapping = new HashMap<String, Class>() {
		{
			put(ByteArray, java.lang.Byte[].class);
	...
	public static Class getJavaTypeClassz(String javaType){
		return javaTypeClassMapping.get(javaType);
	}
