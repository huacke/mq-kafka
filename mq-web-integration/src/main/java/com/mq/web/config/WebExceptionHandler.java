...
public class WebExceptionHandler {
	...
	public ResultHandleT handleException(Exception ex) {
		ex.printStackTrace();
		if (ex instanceof HttpMessageConversionException) {
			log.error("throw Exception!cause:{}", ex.getStackTrace());
			return ResultHandleT.error(ErrorCode.REQ_PARA_NORULE_ERROR,ex);
			...
			log.error("throw Exception!cause:{}", ex.getStackTrace());
			return ResultHandleT.error(ErrorCode.REQ_PARA_TYPE_NOMATCH_ERROR,ex);
		} else if (ex instanceof MissingServletRequestParameterException) {
			log.error("throw Exception!cause:{}", ex.getStackTrace());
			return ResultHandleT.error(ErrorCode.REQ_PARA_INCOMPLETE_ERROR,ex);
			...
			return  ResultHandleT.error(ErrorCode.REQ_VALIDATE_ERROR,checkMsg);
